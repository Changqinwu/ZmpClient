...
import com.dfqm.web.webdemo.adapter.MyListViewAdapter;
import com.dfqm.web.webdemo.adapter.OnNetworkChangeListener;
import com.dfqm.web.webdemo.customview.MyListView;
import com.dfqm.web.webdemo.customview.WifiConnDialog;
import com.dfqm.web.webdemo.customview.WifiStatusDialog;
...
public class WifiSetActivity extends BaseActivity {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            private void isConnect(ScanResult scanResult) {
                if (mWifiAdmin.isConnect(scanResult)) {
                    ...
                    WifiStatusDialog mStatusDialog = new WifiStatusDialog(
                            WifiSetActivity.this, R.style.defaultDialogStyle,
                            scanResult, mOnNetworkChangeListener);
                    mStatusDialog.show();
                } else {
                    // 未连接显示连接输入对话框
                    WifiConnDialog mDialog = new WifiConnDialog(
                            WifiSetActivity.this, R.style.defaultDialogStyle, listView, mPosition, mAdapter,
            ...
            private void isConnectSelf(ScanResult scanResult) {
                if (mWifiAdmin.isConnect(scanResult)) {
                    ...
                    if (iswifi) {
                        Toast.makeText(WifiSetActivity.this, "连接成功！", Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(WifiSetActivity.this, "连接失败！", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
    ...
    private static class MyHandler extends Handler {
        ...
        private WeakReference<WifiSetActivity> reference;

        public MyHandler(WifiSetActivity activity) {
            this.reference = new WeakReference<WifiSetActivity>(activity);
        }

        @Override
        public void handleMessage(Message msg) {

            WifiSetActivity activity = reference.get();
