    ...
    private void setListener() {
        ...
        txtBtnConn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //保存网络配置
                SharedPreferencesUtils.setString(context,"ssId",scanResult.SSID);
                SharedPreferencesUtils.setString(context,"wifiPwd",edtPassword.getText().toString().trim());
                SharedPreferencesUtils.setString(context,"type", String.valueOf(type));
